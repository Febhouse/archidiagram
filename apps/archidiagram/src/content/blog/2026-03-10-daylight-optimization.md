...
1. **Shadow Slice:** Essential for cutting the building open to visualize the interior layout without breaking the exterior shadows.
2. **Sun Diagram:** To generate the 3D solar dome and animate the sunlight sweeping through the rooms.
...
This sample project is available for **free download**. Use it to learn how to deliver maximum value and a premium living experience in your compact housing projects.
 ...
 [ Free download via GoogleDrive ](https://drive.google.com/file/d/1PnRp2kIH-0wDbFdAnsZoWTW4CIUfOgOj/)
