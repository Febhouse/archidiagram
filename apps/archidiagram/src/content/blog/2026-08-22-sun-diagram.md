...
<div class="space-y-12">
  ...
  <div class="space-y-6">
    <div class="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800 pb-3">
      ...
      <h2 class="text-2xl font-black text-slate-900 dark:text-white">The plugin has 04 core features.</h2>
    </div>
  ...
  <div class="p-6 sm:p-8 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
    <h3 class="text-xl font-bold text-slate-900 dark:text-white">What You Can Do with Sun Diagram:</h3>
  ...
  <div class="p-6 sm:p-8 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm text-center space-y-6">
    <h3 class="text-xl font-bold text-slate-900 dark:text-white">Explore Diagrams Created with Sun Diagram</h3>
    <div class="max-w-2xl mx-auto rounded-xl overflow-hidden shadow-lg border border-slate-200 dark:border-slate-800">
      <img src="/images/2025/10/SHADOWANALYSIS-DEC.gif" alt="Diagrams Created with Sun Diagram" class="w-full object-cover" />
    </div>
    <div>
  ...
  <div id="download" class="space-y-6 pt-4">
    <div class="text-center space-y-2">
      <h2 class="text-3xl font-black text-slate-900 dark:text-white">Get Sun Diagram</h2>
      <p class="text-sm text-slate-500 dark:text-slate-400">Choose the license that fits your professional workflow</p>
    </div>
    ...
    <div class="p-4 rounded-xl bg-slate-100 dark:bg-slate-800/60 text-center text-xs text-slate-600 dark:text-slate-400 space-y-1">
      ...
      <p>📩 Support: <a href="mailto:info@febhouse.com" class="text-amber-500 font-medium underline">info@febhouse.com</a> (response within 24h)</p>
    </div>
  </div>
  ...
  <div class="p-6 sm:p-8 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
    <div class="flex items-center gap-3">
      ...
      <span class="text-xs text-slate-500 font-mono">2026-07-03</span>
    </div>
    <p class="text-sm text-slate-700 dark:text-slate-300">
      <strong>🛠️ Bug Fixes & Stability Improvements:</strong> Text Stability on Save/Autosave: Fixed a critical issue where sun path hour labels (12h, 14h, 16h, etc.) would randomly disappear when saving the model in SketchUp 2023 and 2026.
    </p>
  ...
  <div class="p-6 sm:p-8 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-center space-y-6">
    ...
    <div>
      <a href="https://drive.google.com/file/d/14pPiWqBubLlpe_Wz6kL7psZ5z9F3DXWU/" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-amber-400 hover:bg-amber-300 text-slate-950 font-bold text-xs uppercase tracking-wider shadow-md transition-all">
        📥 Download Sun Diagram User Guide (PDF)
      </a>
    </div>
  </div>
