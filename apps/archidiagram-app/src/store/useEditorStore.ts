  ...
  duplicateObjects: (ids) => set((state) => {
...
}),
    {
      ...
      partialize: (state) => ({ 
        ...
        monthColorsLight: state.monthColorsLight,
        monthColorsDark: state.monthColorsDark,
        gridSize: state.gridSize,
        showHUD: state.showHUD,
        hudScale: state.hudScale,
        uiTheme: state.uiTheme,
        globalTextSize: state.globalTextSize,
        showMapBackground: state.showMapBackground,
        mapZoom: state.mapZoom,
        mapStyle: state.mapStyle,
        mapOpacity: state.mapOpacity,
        mapRadius: state.mapRadius,
        showScaleRings: state.showScaleRings,
        scaleRingStep: state.scaleRingStep,
        scaleRingCount: state.scaleRingCount,
        scaleRingUnit: state.scaleRingUnit,
        exportWidth: state.exportWidth,
        exportHeight: state.exportHeight,
        showSunDiagramLayer: state.showSunDiagramLayer,
        showDynamicSymbolsLayer: state.showDynamicSymbolsLayer
      }),
    }
  )
)
